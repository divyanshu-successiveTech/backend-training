...
import { locationCheckMiddlewareInterface } from "../Interfaces/locationCheckMiddlewareInterface";
...
class LocationCheck implements locationCheckMiddlewareInterface{

    locationCheck=(req:Request,res:Response,next:NextFunction)=>{
...
export  const locationCheck = new LocationCheck